...
struct WLNParser {
    ...
    // ptr points to 'L' or 'T' <-- need to keep this convention in order to reuse existing framework
    bool parse_ring() {
        unsigned int size = 0;
        int ptr_it=0;
...
{
  fprintf(stderr, "old_readwln <options> -o<format> -s <input (escaped)>\n");
